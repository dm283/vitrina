...
# TABLE_FOR_INSERTS = TABLE_FOR_INSERTS_CONSIGNMENTS
# COLUMNS_IN_TABLE_FOR_INSERTS = COLUMNS_IN_TABLE_FOR_INSERTS_CONSIGNMENTS
# QUERY_LOAD_DATA = QUERY_LOAD_DATA_CONSIGNMENTS
