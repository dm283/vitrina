...
.bootstrap-table .fixed-table-container .table th{background-color: Indigo; color: GhostWhite; text-align: center; font-size: 13px;}
.bootstrap-table .fixed-table-container .table td{color: DarkSlateGray; font-size: 14px; font-weight: normal;}
